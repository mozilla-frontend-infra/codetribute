...
class ProjectIcon extends Component {
  render() {
    ...
    case 'cloud': return <CloudSyncIcon size={50} className={classes.projectIcon} />;
    case 'calendar': return  <CalendarIcon size={50} className={classes.projectIcon} />;
    case 'lead': return <LeadPencilIcon size={50} className={classes.projectIcon} />;
    case 'target': return  <TargetIcon size={50} className={classes.projectIcon} />;
    case 'view': return <ViewDashboardVariantIcon size={50} className={classes.projectIcon} />;
    ...
    case 'package': return <PackageVariantIcon size={50} className={classes.projectIcon} />;
    ...
    case 'desktop': return <DesktopMacIcon size={50} className={classes.projectIcon} />;
    case 'sitemap': return  <SitemapIcon size={50} className={classes.projectIcon} />;
    case 'image': return <ImageSearchIcon size={50} className={classes.projectIcon} />;
    case 'file': return <FileDocumentBoxMultipleIcon size={50} className={classes.projectIcon} />;
    case 'server': return  <ServerIcon size={50} className={classes.projectIcon} />;
    case 'vector': return <VectorCombineIcon size={50} className={classes.projectIcon} />;
    case 'format': return <FormatIndentIncreaseIcon size={50} className={classes.projectIcon} />;
    case 'radio': return <RadioTowerIcon size={50} className={classes.projectIcon} />;
    case 'test': return <TestTubeIcon size={50} className={classes.projectIcon} />;
    case 'book': return <BookOpenPageVariantIcon size={50} className={classes.projectIcon} />;
    case 'email': return  <EmailIcon size={50} className={classes.projectIcon} />;
    case 'pine': return <PineTreeIcon size={50} className={classes.projectIcon} />;

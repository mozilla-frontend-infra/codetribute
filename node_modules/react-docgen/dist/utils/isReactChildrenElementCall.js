...
function isReactChildrenElementCall(path) {
  ...
  if (!(0, _match2.default)(path.node, { callee: { property: { name: 'only' } } })) {
    return false;
  }

  var calleeObj = path.get('callee', 'object');
  var module = (0, _resolveToModule2.default)(calleeObj);

  if (!(0, _match2.default)(calleeObj, { value: { property: { name: 'Children' } } })) {
    return false;
  }

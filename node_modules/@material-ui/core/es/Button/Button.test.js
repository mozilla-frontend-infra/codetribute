...
var _ref14 = React.createElement(Button, {
  variant: "fab",
  mini: true
}, "Hello World");
...
var _ref16 = React.createElement(Button, {
  variant: "fab",
  color: "secondary"
}, "Hello World");

var _ref17 = React.createElement(Button, null, "Hello World");

var _ref18 = React.createElement(Button, {
  disableRipple: true
}, "Hello World");

var _ref19 = React.createElement(Button, null, "Hello World");

var _ref20 = React.createElement(Button, {
  disableFocusRipple: true
}, "Hello World");

var _ref21 = React.createElement(Button, null, "Hello World");
...
describe('<Button />', () => {
  ...
  it('should render a primary outlined button', () => {
    ...
    assert.strictEqual(wrapper.hasClass(classes.root), true);
    assert.strictEqual(wrapper.hasClass(classes.outlined), true, 'should have the outlined class');
    assert.strictEqual(wrapper.hasClass(classes.flatPrimary), true, 'should have the flatPrimary class');
    assert.strictEqual(wrapper.hasClass(classes.raised), false, 'should not have the raised class');
    assert.strictEqual(wrapper.hasClass(classes.fab), false, 'should not have the fab class');
  });
  it('should render a secondary outlined button', () => {
    ...
    assert.strictEqual(wrapper.hasClass(classes.root), true);
    assert.strictEqual(wrapper.hasClass(classes.outlined), true, 'should have the outlined class');
    assert.strictEqual(wrapper.hasClass(classes.flatSecondary), true, 'should have the flatSecondary class');
    assert.strictEqual(wrapper.hasClass(classes.raised), false, 'should not have the raised class');
    assert.strictEqual(wrapper.hasClass(classes.fab), false, 'should not have the fab class');
  });

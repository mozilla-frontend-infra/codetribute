...
var _ref14 = _react.default.createElement(_Button.default, {
  variant: "fab",
  mini: true
}, "Hello World");
...
var _ref16 = _react.default.createElement(_Button.default, {
  variant: "fab",
  color: "secondary"
}, "Hello World");

var _ref17 = _react.default.createElement(_Button.default, null, "Hello World");

var _ref18 = _react.default.createElement(_Button.default, {
  disableRipple: true
}, "Hello World");

var _ref19 = _react.default.createElement(_Button.default, null, "Hello World");

var _ref20 = _react.default.createElement(_Button.default, {
  disableFocusRipple: true
}, "Hello World");

var _ref21 = _react.default.createElement(_Button.default, null, "Hello World");
...
describe('<Button />', function () {
  ...
  it('should render an outlined button', function () {
    var wrapper = shallow(_ref10);

    _chai.assert.strictEqual(wrapper.hasClass(classes.root), true);

    _chai.assert.strictEqual(wrapper.hasClass(classes.outlined), true, 'should have the outlined class');

    _chai.assert.strictEqual(wrapper.hasClass(classes.raised), false, 'should not have the raised class');

    _chai.assert.strictEqual(wrapper.hasClass(classes.fab), false, 'should not have the fab class');
  });
  it('should render a primary outlined button', function () {
    ...
    _chai.assert.strictEqual(wrapper.hasClass(classes.flatPrimary), true, 'should have the flatPrimary class');

    _chai.assert.strictEqual(wrapper.hasClass(classes.raised), false, 'should not have the raised class');

    _chai.assert.strictEqual(wrapper.hasClass(classes.fab), false, 'should not have the fab class');
  });
  it('should render a secondary outlined button', function () {
    ...
    _chai.assert.strictEqual(wrapper.hasClass(classes.flatSecondary), true, 'should have the flatSecondary class');

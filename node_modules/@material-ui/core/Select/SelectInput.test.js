...
var _ref = _react.default.createElement(_MenuItem.default, {
  key: 1,
  value: 10
}, "Ten");

var _ref2 = _react.default.createElement(_MenuItem.default, {
  key: 2,
  value: 20
}, "Twenty");
...
var _ref4 = _react.default.createElement(_MenuItem.default, null);

var _ref5 = _react.default.createElement(_MenuItem.default, {
  value: ""
}, "Ten");
...
var _ref7 = _react.default.createElement(_MenuItem.default, {
  value: 30
}, "Thirty");

var _ref10 = _react.default.createElement(_MenuItem.default, null, "Hello");
...
describe('<SelectInput />', function () {
  ...
  it('should render a correct top element', function () {
    ...
    _chai.assert.strictEqual(wrapper.find(_MenuItem.default).at(0).props()['data-value'], 10);
  });
  ...
  describe('prop: native=false', function () {
    ...
    describe('prop: open (controlled)', function () {
      ...
      it('should allow to control closing by passing onClose props', function () {
        ...
        wrapper.find(_MenuItem.default).simulate('click');
  ...
  describe('prop: multiple', function () {
    ...
    it('should serialize multiple select value', function () {
      ...
      _chai.assert.deepEqual(wrapper.find(_MenuItem.default).map(function (wrapper2) {

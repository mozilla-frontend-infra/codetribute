...
describe('<MobileStepper />', function () {
  ...
  it('should render a <LinearProgress /> when supplied with variant progress', function () {
    ...
    _chai.assert.lengthOf(wrapper.find(_LinearProgress.default), 1, 'should render a <LinearProgress />');
  });
  it('should calculate the <LinearProgress /> value correctly', function () {
    ...
    var linearProgressProps = wrapper.find(_LinearProgress.default).props();
    ...
    linearProgressProps = wrapper.find(_LinearProgress.default).props();

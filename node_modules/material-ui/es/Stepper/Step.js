...
function Step(props) {
  ...
  return React.createElement("div", _extends({
    className: className
  }, other), React.Children.map(children, child => React.cloneElement(child, _objectSpread({
    active,
    alternativeLabel,
    completed,
    disabled,
    ...
    last,
    orientation
  }, child.props))), connector && alternativeLabel && !last && React.cloneElement(connector, {
    orientation,
    alternativeLabel
  }));
}

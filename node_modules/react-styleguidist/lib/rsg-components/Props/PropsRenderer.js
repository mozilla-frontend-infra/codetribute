		...
		if (prop.type || prop.flowType) {
			...
			if (defaultValueBlacklist.indexOf(prop.defaultValue.value) > -1) {
				...
				try {
					...
					return React.createElement(
						Text,
						{ size: 'small', color: 'light', underlined: true, title: objectToString(object, null, 2) },
						'Shape'
					);
				} catch (e) {
...
function renderDescription(prop) {
	...
	return React.createElement(
		...
		returnDocumentation && React.createElement(Argument, _extends({}, returnDocumentation, { returns: true }))
	);
}
